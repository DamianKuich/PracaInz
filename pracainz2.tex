...
Ostatni rozdział opisuje javascriptową bibliotekę React, jej historię, specyfikacją oraz użycie w procesie budowania interfejsu projektu Gen-mat. Rozdział dodatkowo przybliża biblioteki Yup, Axios oraz Formik używane przy tworzeniu oraz wymianie formularzy.
