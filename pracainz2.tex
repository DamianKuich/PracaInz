...
Django Software Foundation. Oficjalna strona framework’a Django
\\\texttt{https://docs.djangoproject.com/en/3.1/}

Dostęp: 2005

\bibitem{latexcompanion} 
Oracle Corporation and/or its affiliates. Dokumentacja MySQL
\\\texttt{https://dev.mysql.com/doc/}


\bibitem{latexcompanion} 
The PostgreSQL Global Development Group. Dokumentacja PostgreSQL
\\\texttt{https://www.postgresql.org/docs/}

Dostęp: 1996
\bibitem{latexcompanion} 
Microsoft. Dokumentacja Microsoft SQL Server
\\\texttt{https://docs.microsoft.com/en-us/sql/sql-server/}

Dostęp: 11/04/2019
\bibitem{latexcompanion} 
Oracle Corporation. Dokumentacja Oracle Database
\\\texttt{https://docs.oracle.com/en/database/}

Dostęp: 2020
\bibitem{latexcompanion} 
Wes Kendall. Dokumentacja django-pghistory
\\\texttt{https://django-pghistory.readthedocs.io/en/latest/index.html}

Dostęp: 27/06/2020
\bibitem{latexcompanion} 
Wes Kendall. Dokumentacja django-pgtrigger
\\\texttt{https://django-pgtrigger.readthedocs.io/en/latest/toc.html}

Dostęp: 27/06/2020
\bibitem{latexcompanion} 
Wes Kendall. Dokumentacja django-pgconnection
...
Data Engineering with Python, Django, and PostgreSQL. Dostęp: 28/02/2019
\end{thebibliography}
