...
\newline
- isSubmitting - który sprawdza stan przesyłania formularza, zwraca wartość \it{true}, gdy formularz jest aktualnie przesyłany, w innym wypadku zwraca \it{false}
\newline
- setFieldError - pozwalający na ustawienie dodatkowej wiadomośc, gdy w wybranym polu wystąpi błąd
\newline
...
\newline - push- który przepycha nowy adres na ostatnie miejsce na stosie historii
